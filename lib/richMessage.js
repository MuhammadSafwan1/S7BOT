    ...
    return [
        {
            ...
            buttonParamsJson: JSON.stringify({
                ...
                url: settings.channelUrl || 'https://whatsapp.com/channel/0029VbBCfpD5PO18ybDE1S0W',
            }),
        },
        {
            name: 'cta_url',
            buttonParamsJson: JSON.stringify({
                ...
                url: settings.youtubeUrl || 'https://youtube.com/@hackthecode7?si=-6zfrP5cUYC-erm5',
            }),
        },
    ];
}
...
function wrapLines(text = '', lineLength = 32, maxLines = 5) {
    ...
    return lines.length ? lines : ['S7 SAFWAN'];
}
